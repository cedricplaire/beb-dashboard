    ...
    <div className={`h-full ${isOpen ? 'w-64' : 'w-20'} bg-gray-800 text-white transition-width duration-300`}>
      <div className="flex flex-col h-full">
        <div className="flex items-center justify-between p-4 ml-1 border-b border-gray-600">
            ...
            <button title="switch bar" type="button" onClick={handleBar} className="p-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
        ...
        <div className="border-b border-gray-700 h-auto w-full grow rounded-md border-t bg-gray-800 md:block"></div>
      </div>
    </div>
    </>
  );
